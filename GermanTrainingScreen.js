...
const GermanTrainingScreen = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                {/* Header with Home (Left) and Back (Right) Buttons */}
      ...
      <View style={styles.videoContainer}>
        ...
        />
                ...
                {/* Next Button */}
                <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('GermanTraining2')}>
...
export default GermanTrainingScreen;
