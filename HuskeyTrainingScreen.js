...
const HuskeyTrainingScreen = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                ...
                {/* Next Button */}
              <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('HuskeyTraining2')}>
...
export default HuskeyTrainingScreen;
