...
const BeagleTraining2 = ({ navigation }) => {
        ...
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => navigation.navigate('BeagleTrainingScreen')}>
                ...
                {/* Title */}
                <Text style={styles.title}>BEAGLE 2</Text>
...
export default BeagleTraining2;
