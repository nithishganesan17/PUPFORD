...
const HomeScreen = () => {
  ...
  const dogBreeds = ['Labrador', 'German Shepherd', 'Husky', 'Golden Retriever', 'Beagle'];
  ...
  const navigateToTraining = () => {
    ...
    if (trainingType === 'trainer') {
      // Navigate to BookTrainer screen if "ALLOTE TRAINER" is selected
      navigation.navigate('BookTrainer', { breed: selectedBreed });
    } else {
      // Navigate to breed-specific training screens for "SELF TRAINING"
      const breedScreens = {
        'Labrador': 'LabradorTrainingScreen',
        'German Shepherd': 'GermanTrainingScreen',
        'Husky': 'HuskyTrainingScreen',
  ...
  return (
    <View style={styles.container}>
      {/* Menu Button */}
      <TouchableOpacity style={styles.menuButton} onPress={() => navigation.navigate('Homemenu')}>
