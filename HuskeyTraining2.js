...
const HuskeyTraining2 = ({ navigation }) => {
        ...
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => navigation.navigate('HuskeyTrainingScreen')}>
                ...
                {/* Title */}
                <Text style={styles.title}>HUSKEY 2</Text>
...
export default HuskeyTraining2;
