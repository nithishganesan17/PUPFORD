...
const LabradorTraining2 = ({ navigation }) => {
        ...
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => navigation.navigate('LabradorTrainingScreen')}>
                ...
                {/* Title */}
                <Text style={styles.title}>Labrador 2</Text>
...
export default LabradorTraining2;
