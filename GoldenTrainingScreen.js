...
const GoldenTrainingScreen = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                ...
                {/* Next Button */}
              <TouchableOpacity style={styles.nextButton} onPress={() => navigation.navigate('GoldenTraining2')}>
...
export default GoldenTrainingScreen;
