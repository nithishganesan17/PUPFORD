...
const GoldenTraining2 = ({ navigation }) => {
        ...
        <View style={styles.container}>
            <ScrollView ref={scrollViewRef} style={styles.scrollView}>
                ...
                <View style={styles.header}>
                    <TouchableOpacity onPress={() => navigation.navigate('GoldenTrainingScreen')}>
                ...
                {/* Title */}
                <Text style={styles.title}>GOLDEN RETRIVER 2</Text>
                ...
                <View style={styles.videoContainer}>
                    <Video
                        source={{ uri: 'https://www.example.com/german-shepherd-training.mp4' }} // Replace with actual video URL
                        style={styles.video}
                        controls={true}
                    />
                </View>
                ...
                <TouchableOpacity style={styles.trainerButton} onPress={() => navigation.navigate('Trainerlist')}>
...
export default GoldenTraining2;
